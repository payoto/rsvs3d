...
function [ccodeGen]=Code_SurfCentroid()
    ...
    x=sym('x_%d__',[1 10]);assume(x,'real');
    y=sym('y_%d__',[1 10]);assume(y,'real');
    z=sym('z_%d__',[1 10]);assume(z,'real');
