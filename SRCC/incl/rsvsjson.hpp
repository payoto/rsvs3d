...
template <class T> void to_json(rsvsjson::json &j, const filltype<T> &p);
template <class T> void from_json(const rsvsjson::json &j, filltype<T> &p);
...
namespace rsvsjson
{
void flatupdate(json &jfin, json &jnew, bool isFlatFin, bool isFlatNew);
}
namespace tetgen
{
