...
template <class T> void PrintMatrixFile(const std::vector<T> &mat, const char *name);
void Deriv1stChainScalar(const Eigen::MatrixXd &dSdc, const Eigen::MatrixXd &dcdd, Eigen::MatrixXd &dSdd);
void Deriv2ndChainScalar(const Eigen::MatrixXd &dSdc, const Eigen::MatrixXd &dcdd, const Eigen::MatrixXd &HSc,
                         const Eigen::MatrixXd &Hcd, Eigen::MatrixXd &HSd);
