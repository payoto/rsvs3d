...
void Volume_df(const std::vector<double>& p0 , const std::vector<double>& p1 , const std::vector<double>& p2 , ArrayVec<double> &   A0 ); 
void Volume_ddf(const std::vector<double>& p0 , const std::vector<double>& p1 , const std::vector<double>& p2 , ArrayVec<double> &   A0 ); 

void Volume2_f(double  d0 , double  d1 , double  d2 , const std::vector<double>& g0s , const std::vector<double>& g1s , const std::vector<double>& g2s , const std::vector<double>& g0e , const std::vector<double>& g1e , const std::vector<double>& g2e , double &   t0 ) ;
void Volume2_df(double  d0 , double  d1 , double  d2 , const std::vector<double>& g0s , const std::vector<double>& g1s , const std::vector<double>& g2s , const std::vector<double>& g0e , const std::vector<double>& g1e , const std::vector<double>& g2e , ArrayVec<double> &   A0 );
void Volume2_ddf(double  d0 , double  d1 , double  d2 , const std::vector<double>& g0s , const std::vector<double>& g1s , const std::vector<double>& g2s , const std::vector<double>& g0e , const std::vector<double>& g1e , const std::vector<double>& g2e , ArrayVec<double> &   A0 ) ; 


void Area_f(const std::vector<double>& p0 , const std::vector<double>& p1 , const std::vector<double>& p2 , double &   t0 , double eps=0.0); 
void Area_df(const std::vector<double>& p0 , const std::vector<double>& p1 , const std::vector<double>& p2 , ArrayVec<double> &   A0, double eps = rsvsmath_automatic_eps_surf); 
void Area_ddf(const std::vector<double>& p0 , const std::vector<double>& p1 , const std::vector<double>& p2 , ArrayVec<double> &   A0, double eps = rsvsmath_automatic_eps_surf); 
...
void SurfIntersect_f(const std::vector<double>& p1 , const std::vector<double>& p2 , const std::vector<double>& v0 ,
	const std::vector<double>& v01 , const std::vector<double>& v02 , const std::vector<double>& v11 , const std::vector<double>& v12 ,
	 const std::vector<double>& c , double &   t0 ); 
void SurfIntersect_df(const std::vector<double>& p1 , const std::vector<double>& p2 , const std::vector<double>& v0 ,
 const std::vector<double>& v01 , const std::vector<double>& v02 , const std::vector<double>& v11 , const std::vector<double>& v12 ,
  const std::vector<double>& c , ArrayVec<double> &   A0 ); 
