...
double   t2,   t3,   t4,   t5,   t6,   t7,   t8,   t9,   t10,   t11,   t12,   t13,   t14,   t15,   t16,   t17,   t18,   t19;
  ...
  t0 = (g0s[1]  +t3)*(t7*t15-t11*t17)*(1.0/6.0)+(g0s[2]  +t9)*(t11*t13-t7*t19)*(1.0/6.0)-(g0s[0]  +t5)*(t13*t15-t17*t19)*(1.0/6.0);
...
double   t2,   t3,   t4,   t5,   t6,   t7,   t20,   t8,   t9,   t10,   t23,   t11,   t12,   t22,   t13,   t14,   t25,   t15,   t16,   t21,   t17,   t18,   t24,   t19,   t26,   t27,   t28;
  t2 = g0e[0]  -g0s[0]  ;
  t3 = g0e[1]  -g0s[1]  ;
  t4 = d0*t2;
  t5 = d0*t3;
  ...
  t27 = g0s[1]  +t5;
  t28 = g0s[0]  +t4;
  A0[0][0] = t26*(t3*t8-t3*t11-t2*t13+t2*t17)*(-1.0/6.0)+t27*(t6*t8-t2*t15-t6*t11+t2*t19)*(1.0/6.0)+t28*(t3*t15-t6*t13-t3*t19+t6*t17)*(1.0/6.0)+t6*(t11*t13-t8*t17)*(1.0/6.0)-t3*(t11*t15-t8*t19)*(1.0/6.0)-t2*(t13*t19-t15*t17)*(1.0/6.0);
  A0[0][1] = t26*(t11*t12-t7*t17)*(-1.0/6.0)+t27*(t11*t14-t7*t19)*(1.0/6.0)+t28*(t12*t19-t14*t17)*(1.0/6.0);
  A0[0][2] = t26*(t10*t13-t8*t16)*(-1.0/6.0)+t27*(t10*t15-t8*t18)*(1.0/6.0)+t28*(t13*t18-t15*t16)*(1.0/6.0);
...
double   t2,   t3,   t4,   t5,   t6,   t7,   t23,   t8,   t9,   t20,   t10,   t11,   t12,   t24,   t13,   t14,   t25,   t15,   t16,   t21,   t17,   t18,   t22,   t19,   t26,   t27,   t28,   t29,   t30,   t31,   t32,   t33,   t34,   t35,   t36,   t37,   t38,   t39,   t40,   t41,   t42,   t43,   t44,   t45,   t46,   t47,   t48,   t49,   t50,   t51,   t52,   t53,   t54,   t55,   t56,   t57,   t58,   t59,   t60,   t61,   t62,   t63,   t64;
  t2 = g0e[0]  -g0s[0]  ;
  t3 = g0e[1]  -g0s[1]  ;
  t4 = d0*t2;
  t5 = d0*t3;
  ...
  A0[0][0] = t6*(t3*t8-t3*t10-t2*t13+t2*t17)*(-1.0/3.0)+t3*(t6*t8-t6*t10-t2*t15+t2*t19)*(1.0/3.0)+t2*(t3*t15-t6*t13-t3*t19+t6*t17)*(1.0/3.0);
  A0[0][1] = t42;
  A0[0][2] = t57;
  A0[1][0] = t42;
  A0[1][2] = t64;
...
double   t2,   t3,   t4,   t5,   t6,   t7,   t8,   t9,   t10;
  ...
  t9 = p1[2]  -p2[2]  ;
  t10 = p1[1]  -p2[1]  ;
  t0 = p0[1]  *(t2*t5-t3*t6)*(1.0/6.0)+p0[2]  *(t3*t4-t2*t7)*(1.0/6.0)-p0[0]  *(t4*t5-t6*t7)*(1.0/6.0)+p1[1]  *(t2*t9-t6*t8)*(1.0/6.0)-p1[2]  *(t2*t10-t4*t8)*(1.0/6.0)-p1[0]  *(t4*t9-t6*t10)*(1.0/6.0)+p2[1]  *(t3*t9-t5*t8)*(1.0/6.0)-p2[2]  *(t3*t10-t7*t8)*(1.0/6.0)+p2[0]  *(t5*t10-t7*t9)*(1.0/6.0);
...
double   t2,   t3,   t4,   t5,   t6,   t7,   t8,   t9,   t10;
  ...
  t9 = p0[1]  -p1[1]  ;
  t10 = p0[0]  -p2[0]  ;
  A0[0][0] = p0[1]  *t3*(1.0/6.0)-p0[2]  *t2*(1.0/6.0)+p1[1]  *t3*(1.0/6.0)-p1[2]  *t2*(1.0/6.0)+p2[1]  *t3*(1.0/6.0)-p2[2]  *t2*(1.0/6.0)-t5*t9*(1.0/6.0)+t6*t8*(1.0/6.0);
  A0[0][1] = p0[0]  *t3*(-1.0/6.0)+p0[2]  *t4*(1.0/6.0)-p1[0]  *t3*(1.0/6.0)+p1[2]  *t4*(1.0/6.0)-p2[0]  *t3*(1.0/6.0)+p2[2]  *t4*(1.0/6.0)+t5*t7*(1.0/6.0)-t6*t10*(1.0/6.0);
  A0[0][2] = p0[0]  *t2*(1.0/6.0)-p0[1]  *t4*(1.0/6.0)+p1[0]  *t2*(1.0/6.0)-p1[1]  *t4*(1.0/6.0)+p2[0]  *t2*(1.0/6.0)-p2[1]  *t4*(1.0/6.0)-t7*t8*(1.0/6.0)+t9*t10*(1.0/6.0);
  A0[0][3] = p0[1]  *t5*(-1.0/6.0)+p0[2]  *t8*(1.0/6.0)-p1[1]  *t5*(1.0/6.0)+p1[2]  *t8*(1.0/6.0)-p2[1]  *t5*(1.0/6.0)+p2[2]  *t8*(1.0/6.0)+t2*t6*(1.0/6.0)-t3*t9*(1.0/6.0);
  A0[0][4] = p0[0]  *t5*(1.0/6.0)-p0[2]  *t10*(1.0/6.0)+p1[0]  *t5*(1.0/6.0)-p1[2]  *t10*(1.0/6.0)+p2[0]  *t5*(1.0/6.0)-p2[2]  *t10*(1.0/6.0)+t3*t7*(1.0/6.0)-t4*t6*(1.0/6.0);
  A0[0][5] = p0[0]  *t8*(-1.0/6.0)+p0[1]  *t10*(1.0/6.0)-p1[0]  *t8*(1.0/6.0)+p1[1]  *t10*(1.0/6.0)-p2[0]  *t8*(1.0/6.0)+p2[1]  *t10*(1.0/6.0)-t2*t7*(1.0/6.0)+t4*t9*(1.0/6.0);
  A0[0][6] = p0[1]  *t6*(1.0/6.0)-p0[2]  *t9*(1.0/6.0)+p1[1]  *t6*(1.0/6.0)-p1[2]  *t9*(1.0/6.0)+p2[1]  *t6*(1.0/6.0)-p2[2]  *t9*(1.0/6.0)+t2*t5*(1.0/6.0)-t3*t8*(1.0/6.0);
  A0[0][7] = p0[0]  *t6*(-1.0/6.0)+p0[2]  *t7*(1.0/6.0)-p1[0]  *t6*(1.0/6.0)+p1[2]  *t7*(1.0/6.0)-p2[0]  *t6*(1.0/6.0)+p2[2]  *t7*(1.0/6.0)-t4*t5*(1.0/6.0)+t3*t10*(1.0/6.0);
  A0[0][8] = p0[1]  *t7*(-1.0/6.0)+p0[0]  *t9*(1.0/6.0)-p1[1]  *t7*(1.0/6.0)+p1[0]  *t9*(1.0/6.0)-p2[1]  *t7*(1.0/6.0)+p2[0]  *t9*(1.0/6.0)-t2*t10*(1.0/6.0)+t4*t8*(1.0/6.0);
...
double   t2,   t3,   t4,   t5,   t6,   t7;
  ...
  t6 = p0[2]  -p1[2]  ;
  t7 = p0[1]  -p2[1]  ;
  t0 = p0[1]  *(t2*t5-t3*t6)*(1.0/6.0)+p0[2]  *(t3*t4-t2*t7)*(1.0/6.0)-p0[0]  *(t4*t5-t6*t7)*(1.0/6.0);
