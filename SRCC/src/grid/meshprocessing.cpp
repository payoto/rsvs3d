...
/**
 * @brief      Generate a vector of coordinates of points at the volume pseudo
 * centroid.
 *
 * @param[in]  meshin  The input mesh
 *
...
/**
 * @brief      Generate a vector of coordinates of points at the surfaces pseudo
 * centroid.
 *
 * @param[in]  meshin  The input mesh
 *
 ...
 *
 * @return     pair of quadratic roots. Returns infinity if there is not
 * intersection.
 */
